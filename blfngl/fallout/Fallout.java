...
public class Fallout
{
	...
	public static final Item Cleaver = new BaseMelee(519, 3, 1, 995, 1, 1).setUnlocalizedName("Cleaver").setCreativeTab(TabFalloutWeap);
	public static final Item ComKnife = new BaseMelee(520, 3, 1, 995, 1, 1).setUnlocalizedName("ComKnife").setCreativeTab(TabFalloutWeap);
	public static final Item CosKnife = new BaseMelee(521, 6, 1, 995, 1, 1).setUnlocalizedName("CosKnife").setCreativeTab(TabFalloutWeap);
	public static final Item CosClean = new BaseMelee(522, 7, 1, 995, 1, 1).setUnlocalizedName("CosClean").setCreativeTab(TabFalloutWeap);
	public static final Item CosFire = new WeapCosFire(523).setUnlocalizedName("CosFire").setCreativeTab(TabFalloutWeap);
	public static final Item FireAxe = new BaseMelee(524, 6, -1, 995, 1, 1).setUnlocalizedName("FireAxe").setCreativeTab(TabFalloutWeap);
	public static final Item Knife = new BaseMelee(525, 5, 2, 995, 1, 1).setUnlocalizedName("Knife").setCreativeTab(TabFalloutWeap);
	public static final Item Machete = new BaseMelee(526, 6, 0, 995, 1, 1).setUnlocalizedName("Machete").setCreativeTab(TabFalloutWeap);
	...
	public static final Item StraightRazor = new BaseMelee(528, 1, 1, 995, 1, 1).setUnlocalizedName("StraightRazor").setCreativeTab(TabFalloutWeap);
	public static final Item Switchblade = new BaseMelee(529, 2, 1, 995, 1, 1).setUnlocalizedName("Switchblade").setCreativeTab(TabFalloutWeap);
	public static final Item PintSizedKnife = new BaseMelee(530, 99999, 1, 995, 1, 1).setUnlocalizedName("PintSizedKnife").setCreativeTab(TabFalloutWeap);
	...
	public static final Item BladedGauntlet = new BaseMelee(532, 6, -1, 995, 1, 1).setUnlocalizedName("BladedGauntlet").setCreativeTab(TabFalloutWeap);
	public static final Item BoxingGloves = new BaseMelee(533, 1, 1, 995, 1, 1).setUnlocalizedName("BoxingGloves").setCreativeTab(TabFalloutWeap);
	public static final Item BrassKnuckles = new BaseMelee(534, 3, 1, 995, 1, 1).setUnlocalizedName("BrassKnuckles").setCreativeTab(TabFalloutWeap);
	...
	public static final Item GoldenGloves = new BaseMelee(536, 2, 1, 995, 1, 1).setUnlocalizedName("GoldenGloves").setCreativeTab(TabFalloutWeap);
	...
	public static final Item pistolFlareGun = new ItemGun(676, 1, 1, 2.3, 2, "blfngl.FlareGunFire", "Blfngl.FlareGunReload", homemadeFuel, 245).setUnlocalizedName("FlareGun").setCreativeTab(TabFalloutPistol);
	public static final Item pistolPewPew = new ItemGun(677, 6, 2, 3, 1, "blfngl.LaserFire", "Blfngl.LaserPistolReload", cellEnergy, 395).setUnlocalizedName("PewPew").setCreativeTab(TabFalloutEnergy);
	public static final Item pistolPulseGun = new ItemGun(678, 3, 5, 2, 3, "blfngl.PulseFire", "Blfngl.PulseGunReload", cellEnergy, 495).setUnlocalizedName("PulseGun").setCreativeTab(TabFalloutEnergy);
	public static final Item pistolHyperbreederAlpha = new ItemGun(679, 4, 10, 3, 1, "blfngl.RechargerFire", "Blfngl.LeverShotgunReload", aGauge20, 3995).setUnlocalizedName("HyperbreederAlpha").setCreativeTab(TabFalloutEnergy);
	public static final Item pistolSonicEmitter = new ItemGun(680, 4, 24, 2, 2, "blfngl.PulseFire", "Blfngl.PulseGunReload", cellEnergy, 3500).setUnlocalizedName("SonicEmitter").setCreativeTab(TabFalloutEnergy);
	...
	public static final Item rifleAER14 = new ItemGun(684, 10, 12, 2.5, 1, "blfngl.LaserFire", "Blfngl.LaserReload", cellMF, 495).setUnlocalizedName("AER14").setCreativeTab(TabFalloutEnergy);
